...
export const milan = (boyName, girlName) => {
    ...
    varnm = boyName; //document.forms["milanform"]["varname"].value;
    kanyanm = girlName; //document.forms["milanform"]["kanyaname"].value;
    ...
    if (varnm == null || varnm == "") {
        ...
        return {
            total: 36,
            matched: totalnumber,
            love_percent: calculate_love_percent(totalnumber),
            message: milanresultmessage,
        }
    }
}

function calculate_love_percent(matchednumber) {

    var result = 0;

    result = ((100 / 36) * matchednumber).toFixed(2);
